...
// 		homeMain.tab.addTab('数据库管理平台','echartsController/open',{isCanClose:false});
		homeMain.tab.addTab('宠物管理系统','welcome',{isCanClose:false});
	});
	//点退出铵钮时，提示
	function logout(){
...
<body>
	<div class="shop-main">
		<div>
			<div class="shop-header">宠物管理系统</div>
