...
<script type="text/javascript">
	...
	$(function() {
		...
		// 	var userRoleId = "${editUser.userRoleId}";//获取编辑用户的角色ID
		var Id = "${editMedicine.id}";//获取编辑用户用户ID
		// 	$("#userRoleId").comboBox();
		// 	if(userRoleId!=""){
	...
	function save() {
		...
		if ($.valid()) {
			// 默认为修改页面
			var urlAddress = "medicineController/updateMedicine";
			// 如果没有获取到id值 则为新增页
			if ($('#hidId').val() == "") {
				urlAddress = "medicineController/insertMedicine";
			}
			//提交保存
			$("#editForm").ajaxSubmit({
				url : urlAddress,
...
<body>
	<div class="modal-body" style="height: 380px;">
		<form id="editForm" class="form-horizontal no-margin">
			<input type="hidden" id="hidId" name="id" value="${editMedicine.id}">
			<div class="form-group">
				<label for="no" class="col-sm-3 col-xs-3 control-label">宠物编号</label>
				<div class="col-sm-8 col-xs-8">
					<input id="no" name="no" value="${editMedicine.no}"
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-8">
					<input id="name" name="name" value="${editMedicine.name}"
						class="form-control" type="text" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-8">
					<input id="phone" name="phone" value="${editMedicine.phone}"
						class="form-control" type="text" />
				</div>
			</div><div class="form-group">
				<label for="bedno" class="col-sm-3 col-xs-3 control-label">床位号</label>
				<div class="col-sm-8 col-xs-8">
					<input id="bedno" name="bedno" value="${editMedicine.bedno}"
						class="form-control" type="text" />
				</div>
			</div>
			<div class="form-group">
				<label for="disease" class="col-sm-3 col-xs-3 control-label">疾病名称</label>
				<div class="col-sm-8 col-xs-8">
					<input id="disease" name="disease" value="${editMedicine.disease}"
						class="form-control" type="text" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-8">
					<input id="remark" name="remark" value="${editMedicine.remark}"
						class="form-control" type="text" />
				</div>
			</div>
