...
<script type="text/javascript">
	...
	$(function() {
		...
		// 	var userRoleId = "${editUser.userRoleId}";//获取编辑用户的角色ID
		var Id = "${editPayable.id}";//获取编辑用户用户ID
		// 	$("#userRoleId").comboBox();
		// 	if(userRoleId!=""){
	...
	function save() {
		...
		if ($.valid()) {
			// 默认为修改页面
			var urlAddress = "payableController/updatePayable";
			// 如果没有获取到id值 则为新增页
			if ($('#hidId').val() == "") {
				urlAddress = "payableController/insertPayable";
			}
			//提交保存
			$("#editForm").ajaxSubmit({
				url : urlAddress,
...
<body>
	<div class="modal-body" style="height: 380px;">
		<form id="editForm" class="form-horizontal no-margin">
			<input type="hidden" id="hidId" name="id" value="${editPayable.id}">
			<div class="form-group">
				<label for="no" class="col-sm-3 col-xs-3 control-label">订单编号</label>
				<div class="col-sm-8 col-xs-8">
					<input id="no" name="no" value="${editPayable.no}"
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-8">
					<input id="price" name="price" value="${editPayable.price}"
						class="form-control" type="text" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="payer" class="col-sm-3 col-xs-3 control-label">付款人</label>
				<div class="col-sm-8 col-xs-8">
					<input id="payer" name="payer" value="${editPayable.payer}"
						class="form-control" type="text" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-8">
					<input id="remark" name="remark" value="${editPayable.remark}"
						class="form-control" type="text" />
				</div>
			</div>
