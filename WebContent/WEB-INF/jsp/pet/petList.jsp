...
// 					modal.open({width:'600px',height:'500px', title : '添加记录', url : 'petController/openEditPage' })
// 				} 
// 			}, { text : '修改', validCount : '1', 
// 				handler : function(rows) {
// 					modal.open({width:'600px',height:'500px', title : '编辑记录', url : 'petController/openEditPage?id=' + rows[0].id })
// 					}
...
// 		initToolBarByFuncPower(toolbar,"${funcPowers}");
		// datagrid 表格配置
		$('#table').datagrid({
		url : 'petController/selectPetList',//查询数据的地址
